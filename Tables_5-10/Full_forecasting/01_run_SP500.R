...
################################################################################################
## Forecasting loop for one series (SP500)
################################################################################################
...
save(QbSD_oos,file="../Full_forecasting_output/QbSD.SP500.Rdata")
save(Taylor_oos,file="../Full_forecasting_output/Taylor.SP500.Rdata")
save(Patton_oos,file="../Full_forecasting_output/Patton.SP500.Rdata")
save(GARCH_oos,file="../Full_forecasting_output/GARCH.SP500.Rdata")
