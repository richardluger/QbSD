...
################################################################################################
## Forecasting loop for one series (DJIA)
################################################################################################
...
save(QbSD_oos,file="../Full_forecasting_output/QbSD.DJIA.Rdata")
save(Taylor_oos,file="../Full_forecasting_output/Taylor.DJIA.Rdata")
save(Patton_oos,file="../Full_forecasting_output/Patton.DJIA.Rdata")
save(GARCH_oos,file="../Full_forecasting_output/GARCH.DJIA.Rdata")
