...
################################################################################################
## Load data and set up index names
## 'Data.Rdata' contains returns for 8 international stock indices and 6 US bank stocks:
## Stock indices: SP500, DJIA, NASDAQ, EURO STOXX50, FTSE, DAX, CAC40, TSX
## Banks: JPM, BAC, CITI, WFC, GS, MS
################################################################################################

load("../../Data/Data.Rdata")
bnam <- c("SP500","DJIA","NASDAQ","EURO STOXX50","FTSE","DAX","CAC40","TSX","JPM","BAC","CITI","WFC","GS","MS")
nb <- length(bnam) 
...
################################################################################################
## Forecasting loop for one series (NASDAQ)
################################################################################################

n <- 3  # index for NASDAQ 
...
save(QbSD_oos,file="../Full_forecasting_output/QbSD.NASDAQ.Rdata")
save(Taylor_oos,file="../Full_forecasting_output/Taylor.NASDAQ.Rdata")
save(Patton_oos,file="../Full_forecasting_output/Patton.NASDAQ.Rdata")
save(GARCH_oos,file="../Full_forecasting_output/GARCH.NASDAQ.Rdata")
