...
################################################################################################
## Forecasting loop for one series (FTSE)
################################################################################################
...
save(QbSD_oos,file="../Full_forecasting_output/QbSD.FTSE.Rdata")
save(Taylor_oos,file="../Full_forecasting_output/Taylor.FTSE.Rdata")
save(Patton_oos,file="../Full_forecasting_output/Patton.FTSE.Rdata")
save(GARCH_oos,file="../Full_forecasting_output/GARCH.FTSE.Rdata")
