...
################################################################################################
## Forecasting loop for one series (CAC40)
################################################################################################
...
save(QbSD_oos,file="../Full_forecasting_output/QbSD.CAC40.Rdata")
save(Taylor_oos,file="../Full_forecasting_output/Taylor.CAC40.Rdata")
save(Patton_oos,file="../Full_forecasting_output/Patton.CAC40.Rdata")
save(GARCH_oos,file="../Full_forecasting_output/GARCH.CAC40.Rdata")
