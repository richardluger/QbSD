...
################################################################################################
## Forecasting loop for one series (TSX)
################################################################################################
...
save(QbSD_oos,file="../Full_forecasting_output/QbSD.TSX.Rdata")
save(Taylor_oos,file="../Full_forecasting_output/Taylor.TSX.Rdata")
save(Patton_oos,file="../Full_forecasting_output/Patton.TSX.Rdata")
save(GARCH_oos,file="../Full_forecasting_output/GARCH.TSX.Rdata")
